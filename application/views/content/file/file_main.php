        ...
        <div class="section-body">
            ...
            <div class="card">
                    ...
                    <div class="card-header-form">
                        ...
                        <?php if($access->created_access ){ ?>
                            ...
                            <button class="btn btn-primary btn-tambah" data-toggle="modal" data-target="#form-modal"
                                ...
                                data-title="Tambah <?= $title ?>" data-action="<?= base_url('file/tambah') ?>"><i class="fas fa-plus"></i> Tambah Data</button>
                ...
                <div class="card-body">
                    ...
                    <?php  $this->load->view('content/file/file_data') ?>
...
<?php  $this->load->view('content/file/file_form') ?>
