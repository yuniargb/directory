                    ...
                    <div class="card-header-form">
                        <?php if($access->created_access ){ ?>
                            <button class="btn btn-primary btn-tambah" data-toggle="modal" data-target="#form-modal"
                                data-title="Tambah <?= $title ?>" data-action="<?= base_url('header_menu/tambah') ?>"><i class="fas fa-plus"></i> Tambah Data</button>
                        <?php } ?> 
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <?php  $this->load->view('content/header_menu/header_menu_data') ?>
                    <?php } ?> 
                </div>
...
<?php  $this->load->view('content/header_menu/header_menu_form') ?>
