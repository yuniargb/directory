                ...
                <td class="text-center">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <button class="btn btn-info btn-sm btn-edit" data-toggle="modal" data-target="#form-modal"
                            ...
                            data-title="Edit <?= $title ?>" data-action="<?= base_url('subkategori/update/'.base64_encode($this->encryption->encrypt($d->id_subkategori))) ?>"
                        ...
                        data-title="Hapus <?= $title ?>" data-action="<?= base_url('subkategori/delete/'.base64_encode($this->encryption->encrypt($d->id_subkategori))) ?>">
