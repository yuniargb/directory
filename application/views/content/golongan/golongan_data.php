    ...
    <table class="table table-striped" id="<?= $access->exported_access ? 'table-1' : 'table-2'?>">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=  $d->golongan_nama ?></td>

                <td><?=  $d->cabang_nama ?></td>

                <td><?=  $d->golongan_umur ?></td>
                ...
                <td class="text-center">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <button class="btn btn-info btn-sm btn-edit" data-toggle="modal" data-target="#form-modal"
                            ...
                            data-title="Edit <?= $title ?>" data-action="<?= base_url('golongan/update/'.base64_encode($this->encryption->encrypt($d->id_golongan))) ?>"
                        ...
                        data-title="Hapus <?= $title ?>" data-action="<?= base_url('golongan/delete/'.base64_encode($this->encryption->encrypt($d->id_golongan))) ?>">
