...
?>
  ...
  <script src="<?php echo base_url(); ?>assets/js/page/modules-datatables.js?v=1.3"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/js/page/features-post-create.js?v.2"></script>
...
<script>var base_url = '<?= base_url() ?>'</script>
  <!-- Template JS File -->
  <script src="<?php echo base_url(); ?>assets/js/scripts.js?v=1.2"></script>
  <script src="<?php echo base_url(); ?>assets/js/custom.js?v=2"></script>

  <?php $this->load->view('content/error_form_modal'); ?>
</body>
</html>