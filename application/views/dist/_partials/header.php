...
}elseif ($this->uri->segment(1) == "layout_top_navigation" || $this->uri->segment(1) == "panitra") {
  $this->load->view('dist/_partials/layout-3');
  $this->load->view('dist/_partials/navbar');
}elseif ($this->uri->segment(1) == "404_override" || $this->uri->segment(1) == "errors_403") {

}elseif (
  $this->uri->segment(1) != "proses_login" && 
  $this->uri->segment(1) != "" && 
  $this->uri->segment(1) != "auth_forgot_password" && 
  $this->uri->segment(1) != "mushaf_show" && 
  $this->uri->segment(1) != "auth_register" && 
  $this->uri->segment(1) != "auth_reset_password" && 
  $this->uri->segment(1) != "errors_503" && 
  $this->uri->segment(1) != "errors_500" && 
  $this->uri->segment(1) != "utilities_contact" && 
  $this->uri->segment(1) != "panitra" && 
  $this->uri->segment(1) != "halaman_mushaf" && 
